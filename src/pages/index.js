...
const IndexPage = () => {
  ...
  const recipes = [
    ...
    { id: 2, title: 'Vegetable Stir-Fry', imageurl: "/images/vegetablestirfry.jpg", category: 'Vegetarian', description: 'Healthy and delicious', link: '/recipes/vegetarian-stir-fry' },
